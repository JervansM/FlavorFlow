namespace FlavorFlowIT13
{
    partial class HrPolicies
    {
        ...
        private void InitializeComponent()
        {
            ...
            hrpoliciessectionleavetimeofftxt = new TextBox();
            label7 = new Label();
            label5 = new Label();
            label2 = new Label();
            label1 = new Label();
            ...
            // 
            hrpoliciessectiocompliancetxt.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold);
            hrpoliciessectiocompliancetxt.Location = new Point(622, 41);
            hrpoliciessectiocompliancetxt.Multiline = true;
            hrpoliciessectiocompliancetxt.Name = "hrpoliciessectiocompliancetxt";
            hrpoliciessectiocompliancetxt.Size = new Size(481, 99);
            hrpoliciessectiocompliancetxt.TabIndex = 15;
            hrpoliciessectiocompliancetxt.Text = resources.GetString("hrpoliciessectiocompliancetxt.Text");
            // 
            // hrpoliciessectionpayrollcompensationtxt
            // 
            hrpoliciessectionpayrollcompensationtxt.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold);
            hrpoliciessectionpayrollcompensationtxt.Location = new Point(50, 414);
            hrpoliciessectionpayrollcompensationtxt.Multiline = true;
            hrpoliciessectionpayrollcompensationtxt.Name = "hrpoliciessectionpayrollcompensationtxt";
            hrpoliciessectionpayrollcompensationtxt.Size = new Size(481, 130);
            hrpoliciessectionpayrollcompensationtxt.TabIndex = 14;
            hrpoliciessectionpayrollcompensationtxt.Text = "- Salaries are released twice a month\r\n- Payslips are available in the HR system\r\n- Deductions apply for: \r\n   > Absences without notice\r\n   > Late arrivals\r\n   > Lost/damaged company property\r\n";
            // 
            // hrpoliciessectionworkplaceconducttxt
            // 
            hrpoliciessectionworkplaceconducttxt.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold);
            hrpoliciessectionworkplaceconducttxt.Location = new Point(50, 234);
            hrpoliciessectionworkplaceconducttxt.Multiline = true;
            hrpoliciessectionworkplaceconducttxt.Name = "hrpoliciessectionworkplaceconducttxt";
            hrpoliciessectionworkplaceconducttxt.Size = new Size(481, 130);
            hrpoliciessectionworkplaceconducttxt.TabIndex = 13;
            hrpoliciessectionworkplaceconducttxt.Text = resources.GetString("hrpoliciessectionworkplaceconducttxt.Text");
            // 
            // hrpoliciessectionleavetimeofftxt
            // 
            hrpoliciessectionleavetimeofftxt.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold);
            hrpoliciessectionleavetimeofftxt.Location = new Point(50, 41);
            hrpoliciessectionleavetimeofftxt.Multiline = true;
            hrpoliciessectionleavetimeofftxt.Name = "hrpoliciessectionleavetimeofftxt";
            hrpoliciessectionleavetimeofftxt.Size = new Size(481, 154);
            hrpoliciessectionleavetimeofftxt.TabIndex = 12;
            hrpoliciessectionleavetimeofftxt.Text = resources.GetString("hrpoliciessectionleavetimeofftxt.Text");
            // 
            // label7
            // 
            label7.AutoSize = true;
            label7.Font = new Font("Segoe UI", 13F, FontStyle.Bold);
            label7.Location = new Point(608, 16);
            label7.Name = "label7";
            label7.Size = new Size(194, 25);
            label7.TabIndex = 8;
            label7.Text = "Section: Compliance  ";
            // 
            // label5
            // 
            ...
            label5.TabIndex = 6;
            label5.Text = "Section: Payroll and Compensation     ";
            // 
            // label2
            // 
            ...
            label2.TabIndex = 4;
            label2.Text = "Section: Workplace Conduct ";
            // 
            // label1
            // 
        ...
        private TextBox hrpoliciessectionleavetimeofftxt;
        private TextBox hrpoliciessectiocompliancetxt;
        private TextBox hrpoliciessectionpayrollcompensationtxt;
        private TextBox hrpoliciessectionworkplaceconducttxt;
    }
}