    ...
    {
        public partial class StaffDashboardMenuFormAppetizer : Form
        {
            public StaffDashboardMenuFormAppetizer()
            {
                InitializeComponent();
            }
            ...
            private void StaffDashboardMenuFormAppetizer_Load(object sender, EventArgs e)
            {
                LoadMenuData(" Appetizers");
            }
        }
    }
