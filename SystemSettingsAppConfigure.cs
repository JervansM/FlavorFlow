...
{
    public partial class SystemSettingsAppConfigure : Form
    {
        public SystemSettingsAppConfigure()
        {
            InitializeComponent();
            ...
            systemusermanagement.BackColor = ColorTranslator.FromHtml("#1e1e1e");
            ...
            systemappconfigure.BackColor = ColorTranslator.FromHtml("#6C6868");
