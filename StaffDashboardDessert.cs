...
{
    public partial class StaffDashboardDessert : Form
    {
        public StaffDashboardDessert()
        {
            InitializeComponent();
        }
        ...
        private void StaffDashboardDessert_Load(object sender, EventArgs e)
        {
            LoadMenuData(" Dessert");
        }
